...
A tool to type-check Python code with [mypy](https://mypy.readthedocs.io/).
    ...
    steps:
      ...
      - name: Set up Python
        ...
        with:
          python-version: "3.12"
      - name: Run Mypy
        run: bash <(curl -s https://raw.githubusercontent.com/lupaxa-cicd-toolbox/mypy/master/src/pipeline.sh)
```
...
```bash
bash <(curl -s https://raw.githubusercontent.com/lupaxa-cicd-toolbox/mypy/master/src/pipeline.sh)
```
...
---------------------------------------------------------- Stage 2: Install Prerequisites --
 [ OK ] mypy is already installed
------------------------------------------------------------- Stage 3: Run mypy (v1.14.0) --
 [ ✅ ] path/to/file
------------------------------------------------------------------------- Stage 4: Report --
